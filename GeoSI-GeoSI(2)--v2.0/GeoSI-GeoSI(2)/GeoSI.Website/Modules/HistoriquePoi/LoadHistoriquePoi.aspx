<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadHistoriquePoi.aspx.cs" Inherits="GeoSI.Website.Modules.HistoriquePoi.LoadHistoriquePoi" %>
...
<head id="Head1" runat="server">
  ...
  <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function alo()
        {
            var t= ext.getElementById("CheckboxSelectionModel1");
            ext.Store1.
        }
        ...
        function AfficherPoi(lat , lon) {
            ...
            if (_lat != "") {
                ...
                var icon = new google.maps.MarkerImage("../../Ressources/Images/Drapeau_vert.png",
            ...
            <Items>
                ...
                <ext:Panel ID="Panel2"
                    ...
                    <Content>
                        ...
                        <div style="position: absolute; top: 0; left: 85%; z-index: 999; margin-top: 2px;">
                        ...
                        <ext:GridPanel ID="GridPanelVoyage"
                                    ...
                                    <Model>
                                        <ext:Model ID="Model1" runat="server">
                                            <Fields>
                                                ...
                                                <ext:ModelField Name="lng" />
                                                <ext:ModelField Name="lat" />
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ID="Column1" runat="server" Text="<%$ Resources:Resource,POI_conducteur%> " DataIndex="conducteur" />
                                    <ext:Column ID="Column2" runat="server" Text="<%$ Resources:Resource,POI_poinom%> " DataIndex="poi" />
                                    <ext:Column ID="Column9" runat="server" Text="<%$ Resources:Resource,POI_typepoi%>" DataIndex="type" />
                                    <ext:Column ID="Column3" runat="server" Text="<%$ Resources:Resource,POI_datedeb%>" DataIndex="dateD" />
                                    <ext:Column ID="Column6" runat="server" Text="<%$ Resources:Resource,POI_datefin%>" DataIndex="dateF" />
                                    <ext:Column ID="Column7" runat="server" Text="Duree" DataIndex="duree" />

                                    <ext:Column ID="Column4" runat="server" Hidden="true" Text="longitude" DataIndex="lng" />
                                    <ext:Column ID="Column5" runat="server" Hidden="true" Text="latitude" DataIndex="lat" />


                                <%--     <ext:CommandColumn ID="CommandColumn1" runat="server" Width="30">
                                        <Commands>
                                            <ext:GridCommand Icon="MapGo" CommandName="Edit" Cls="ajax">
                                                <ToolTip Text="<%$ Resources:Resource,AfficherPoi%>" />
                                            </ext:GridCommand>
                                        </Commands>
                                        <Listeners>
                                            <Command Handler="AfficherPoi( record.data.lng,record.data.lat);" />
                                        </Listeners>
                                    </ext:CommandColumn> --%>
                             ...
                             <SelectionModel>
                                <ext:CheckboxSelectionModel ID="CheckboxSelectionModel1" runat="server" >
                                    <Listeners>
                                        <Select Handler="AfficherPoi(record.data.lng, record.data.lat); " />
                            ...
                            <TopBar>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Button ID="Button1" runat="server" Text="<%$ Resources:Resource,Poi_ObtenirPoi%>" OnDirectClick="HistoriquePoi">
                                        </ext:Button>
