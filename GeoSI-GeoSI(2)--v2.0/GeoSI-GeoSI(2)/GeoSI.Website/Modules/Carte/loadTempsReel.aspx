<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loadTempsReel.aspx.cs" Inherits="GeoSI.Website.Modules.TempsReel.loadTempsReel" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Ressources/Scripts/common/GMaps.js"></script>
     <script src="../../Ressources/Scripts/common/js_common_module.js" type="text/javascript"></script>
    	<script src="../../Ressources/Scripts/common/markerwithlabel.js" type="text/javascript"></script>
        ...
        function aff_veh_New(id) {
          ...
          new google.maps.Point(10, 25));
            ...
            var mTempMaker = new MarkerWithLabel({
                ...
                map: carte,
                icon: mStartIcon,
                labelContent: infoVehicule.matricule,
